export const DISTRICTS = [
  { name: "수원지구", temples: ["안산교당", "안산국제교당", "수원교당", "동수원교당", "용인교당", "기흥교당", "죽전교당", "동탄교당", "화성교당", "평택교당", "오산교당", "병점교당", "안성교당", "판교교당"] },
...
export const SUBWAY_LINES = [
  ...
  { name: "신분당선", color: "#D4003B", temples: ["판교교당"] },
  { name: "경춘선", color: "#0C8E72", temples: ["남양주교당", "가평교당"] },
  { name: "경강선", color: "#003DA5", temples: ["판교교당", "경기광주교당", "이천교당", "여주교당"] },
